...
if ( function_exists( 'str_fs' ) ) {
    ...
    if ( !function_exists( 'str_fs' ) ) {
        ...
        define( 'STP_PLUGIN_VERSION', '2.2.5' );
        // load custom mimes
        ...
        function stp_style_and_scripts() {
            ...
            wp_register_script(
                'stp',
                STP_PLUGIN_DIR . 'public/js/script.js',
                array('jquery'),
                STP_PLUGIN_VERSION,
                false
            );
        ...
        if ( str_fs()->can_use_premium_code__premium_only() && file_exists( __DIR__ . '/premium-files/metabox-pro.php' ) ) {
            // pro version code
            ...
            require_once 'premium-files/assets.php';
        }
    }
