 ...
 *
 */
if ( ! class_exists( 'STREAMCAST_STREAMCAST_CSF_Walker_Nav_Menu_Edit' ) && class_exists( 'Walker_Nav_Menu_Edit' ) ) {
  class STREAMCAST_STREAMCAST_CSF_Walker_Nav_Menu_Edit extends Walker_Nav_Menu_Edit {
