 ...
 *
 */
if ( ! class_exists( 'STREAMCAST_STREAMCAST_CSF_Fields' ) ) {
  abstract class STREAMCAST_STREAMCAST_CSF_Fields extends STREAMCAST_STREAMCAST_CSF_Abstract {
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="streamcast-csf-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="streamcast-csf-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="streamcast-csf-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="streamcast-csf-help"><span class="streamcast-csf-help-text">'. $this->field['help'] .'</span><i class="fas fa-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="streamcast-csf-error-text">'. $this->field['_error'] .'</div>' : '';
